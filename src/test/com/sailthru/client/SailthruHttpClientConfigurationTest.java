...
class SailthruHttpClientConfigurationTest {
    ...
    @Test void configValues() {
        ...
        assertThat(connManager.getMaxTotal()).as("max total connections").isEqualTo(httpClientConfiguration.getMaxTotalConnections());
        assertThat(connManager.getDefaultMaxPerRoute()).as("default max connections per route").isEqualTo(httpClientConfiguration.getDefaultMaxConnectionsPerRoute());
    }
